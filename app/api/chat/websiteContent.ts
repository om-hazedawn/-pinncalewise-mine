export const websiteContent = {
  companyFormation: {
    ...
    content: `We provide professional Hong Kong company registration services to help you quickly establish a limited company.
...
5. Business nature`,
  ...
  companySecretary: {
    ...
    content: `Annual Company Secretary Service Plans:
...
These terms are governed by the laws of Hong Kong SAR. Any disputes will be resolved under Hong Kong law.`,
  ...
  privacyPolicy: {
    ...
    content: `We handle all client information with strict confidentiality in accordance with Hong Kong law.
